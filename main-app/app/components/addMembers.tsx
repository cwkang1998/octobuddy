...
import { type JSX, type SVGProps, SetStateAction, useState } from "react";
...
export default function AddMembers() {
	...
	const [selectedContacts, setSelectedContacts] = useState<
		{ id: number; name?: string; address?: string; avatar?: string }[]
	>([]);
	...
	const handleSplitBill = () => {
		...
		router.push(
			`/splitbill?amount=${billAmount}&purpose=${encodeURIComponent(billPurpose)}&contacts=${contactsEncoded}`,
		);
	};
	...
	return (
		<Card className="w-full max-w-3xl">
			<CardHeader>
				...
				<CardDescription>
					Choose the members you want to split the bill with.
				</CardDescription>
			</CardHeader>
			...
			<CardFooter>
				<Button className="w-full" onClick={handleSplitBill}>
					Split Bill
				</Button>
			</CardFooter>
		</Card>
